...
public final class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V>
    ...
    final class KeyIterator
            extends HashIterator implements IReusableIterator<K>, Enumeration<K> {
    ...
    final class ValueIterator
            extends HashIterator implements IReusableIterator<V>, Enumeration<V> {
